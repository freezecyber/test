...
namespace MonoFlat
{
        ...
        protected sealed override void OnParentChanged(EventArgs e)
        {
            ...
            if (!_ControlMode)
            {
                ...
                if (_IsParentForm)
                {
                    ...
                    if (!DesignMode) ParentForm.Shown += FormShown;
                }
    ...
    public class MonoFlat_TextBox : Control
    {
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (MonoFlatTB != null)
                {
                    ...
                    if (value) MonoFlatTB.Height = Height - 23;
                    else Height = MonoFlatTB.Height + 23;
                }
            }
        }
        ...
        {
            base.OnResize(e);
            if (_Multiline) MonoFlatTB.Height = Height - 23;
            else Height = MonoFlatTB.Height + 23;
        ...
        public void _TextChanged(object sender, System.EventArgs e)
        {
            Text = MonoFlatTB.Text;
        }

        public void _BaseTextChanged(object sender, System.EventArgs e)
        {
            MonoFlatTB.Text = Text;
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null) MonoFlatTB.Width = Width - 18;
            else MonoFlatTB.Width = Width - 45;
    ...
    public class MonoFlat_TrackBar : Control
    {
        ...
        public int Minimum
        {
            ...
            set
            {
                ...
                if (value >= _Maximum) value = _Maximum - 10;
        ...
        public int Maximum
        {
            ...
            set
            {
                ...
                if (value <= _Minimum) value = _Minimum + 10;
                if (_Value > value) _Value = value;
